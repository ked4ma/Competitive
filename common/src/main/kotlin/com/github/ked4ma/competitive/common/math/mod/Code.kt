...
fun Long.plus(n: Long, mod: Long) = (this + n).mod(mod)
fun Long.minus(n: Long, mod: Long) = (this - n + mod).mod(mod)
fun Long.times(n: Long, mod: Long) = (this * n).mod(mod)
fun Long.div(n: Long, mod: Long) = (this * modinv(n, mod)).mod(mod)
